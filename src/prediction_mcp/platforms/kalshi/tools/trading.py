...
def get_tools() -> List[types.Tool]:
    return [
        types.Tool(name="kalshi_create_order", description="Create order", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "side": {"type": "string", "enum": ["yes", "no"]}, "action": {"type": "string", "enum": ["buy", "sell"]}, "count": {"type": "integer"}, "price": {"type": "integer"}}, "required": ["ticker", "side", "action", "count"]}),
        types.Tool(name="kalshi_cancel_order", description="Cancel order", inputSchema={"type": "object", "properties": {"order_id": {"type": "string"}}, "required": ["order_id"]}),
        types.Tool(name="kalshi_batch_cancel_orders", description="Cancel multiple orders", inputSchema={"type": "object", "properties": {"order_ids": {"type": "array", "items": {"type": "string"}}, "ticker": {"type": "string"}}, "required": []}),
        types.Tool(name="kalshi_get_order", description="Get order details", inputSchema={"type": "object", "properties": {"order_id": {"type": "string"}}, "required": ["order_id"]}),
        types.Tool(name="kalshi_get_orders", description="Get orders", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "status": {"type": "string"}, "limit": {"type": "integer"}}, "required": []}),
        types.Tool(name="kalshi_amend_order", description="Amend order", inputSchema={"type": "object", "properties": {"order_id": {"type": "string"}, "count": {"type": "integer"}, "price": {"type": "integer"}}, "required": ["order_id"]}),
        types.Tool(name="kalshi_get_fills", description="Get fills", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "limit": {"type": "integer"}}, "required": []}),
        types.Tool(name="kalshi_calculate_order_cost", description="Calculate order cost", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "side": {"type": "string"}, "action": {"type": "string"}, "count": {"type": "integer"}, "price": {"type": "integer"}}, "required": ["ticker", "side", "action", "count", "price"]}),
        types.Tool(name="kalshi_estimate_slippage", description="Estimate slippage", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "side": {"type": "string"}, "count": {"type": "integer"}}, "required": ["ticker", "side", "count"]}),
        types.Tool(name="kalshi_get_best_price", description="Get best bid/ask", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}}, "required": ["ticker"]}),
        types.Tool(name="kalshi_check_order_validity", description="Validate order", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "side": {"type": "string"}, "action": {"type": "string"}, "count": {"type": "integer"}, "price": {"type": "integer"}}, "required": ["ticker", "side", "action", "count", "price"]}),
        types.Tool(name="kalshi_simulate_order", description="Simulate order", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "side": {"type": "string"}, "action": {"type": "string"}, "count": {"type": "integer"}, "price": {"type": "integer"}}, "required": ["ticker", "side", "action", "count", "price"]}),
        types.Tool(name="kalshi_get_order_history", description="Get order history", inputSchema={"type": "object", "properties": {"ticker": {"type": "string"}, "limit": {"type": "integer"}}, "required": []}),
    ]
